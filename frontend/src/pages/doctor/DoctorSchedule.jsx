  ...
  const fetchSchedule = async () => {
    try {
      const res = await axios.get(
        `https://mediconnect-7v1m.onrender.com/doctor/schedule?doctorId=${doctorId}`
      );
    ...
    try {
      const endpoint =
        slotData.type === "available"
          ? "https://mediconnect-7v1m.onrender.com/doctor/availability"
          : "https://mediconnect-7v1m.onrender.com/doctor/busy";
    ...
    if (
      ...
      try {
        const endpoint = isBusy
          ? `https://mediconnect-7v1m.onrender.com/doctor/busy/${id}`
          : `https://mediconnect-7v1m.onrender.com/doctor/availability/${id}`;
      ...
      <div>
        ...
        <button
          ...
          onClick={() => {
            ...
            window.location.href = `https://mediconnect-7v1m.onrender.com/google/login?token=${token}`;
          }}
        >
          ...
          onClick={async () => {
            try {
              const res = await fetch(
                "https://mediconnect-7v1m.onrender.com/google/sync-busy",
                {
                  headers: {
