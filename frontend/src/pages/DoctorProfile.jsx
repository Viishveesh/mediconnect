        ...
        <div className="container" style={{ paddingBottom: '125px'}}>
          <div className="row align-items-center">
            ...
            <div className="col-md-8">
              ...
              <button className="btn btn-light rounded-pill px-5"
                onClick={() => navigate(`/book-appointment/${doctorId}`)} > Book Appointment </button>
              <h3>Add more details here about the doc and reduce the padding </h3>
            </div>
          </div>
        </div>
      </section>
